...
A Consent Request is initiated when a [Data Subject](#Subject) specifies or changes consent preferences.
...
A successful response MUST include the `204 No Content` response status code.
